...
Product1= Product.create!(title: "Salient Style Wool Coat", designer_id: Designer1, category_id: Category1, 
...
Product2= Product.create!(title: "Along for the Ride Coat", designer_id: Designer2, category_id: Category1, 
...
Product3= Product.create!(title: "Set for the Solstice Coat", designer_id: Designer3, category_id: Category1, 
...
Product4= Product.create!(title: "Kotto Faux Fur Jacket", designer_id: Designer4, category_id: Category1, 
...
Product5= Product.create!(title: "Looking Lively Faux Fur Jacket", designer_id: Designer5, category_id: Category1, 
...
Product6= Product.create!(title: "Escape to Nature Coat", designer_id: Designer6, category_id: Category1, 
    stylist_notes: "Keep warm in cold weather with this faux fur jacket, featuring a hood, purple everything, ribbed trim, front zip closure with a pull ring, and a woven lining.", 
    product_details: "Lilac crepe (100% Polyester). Jacket. Long sleeves. Fully lined. Tie closure at waist. 27.5\" from shoulder to hemline. Imported.", 
    size_fit:"Model is 5\'8\" and wearing a Small. This product tends to run larger.", retail_price: 185, rent_price:30, color: "purple", weather: "WARM WEATHER", 
    sleeves: "LONG SLEEVES")  

Item1 = Item.create!(product_id: Product1, size: 4, quantity: 10 )
Item2 = Item.create!(product_id: Product2, size: 6, quantity: 10 )
Item3 = Item.create!(product_id: Product3, size: 8, quantity: 10 )
Item4 = Item.create!(product_id: Product2, size: 10, quantity: 10 )
Item5 = Item.create!(product_id: Product4, size: 0, quantity: 10 )
Item6 = Item.create!(product_id: Product5, size: 2, quantity: 10 )
Item7 = Item.create!(product_id: Product6, size: 14, quantity: 10 )
Item8 = Item.create!(product_id: Product4, size: 12, quantity: 10 )

Shopping_Cart1 = ShoppingCartItem.create!(user_id: User1, item_id: 1 )
Shopping_Cart2 = ShoppingCartItem.create!(user_id: User1, item_id: 2 )
Shopping_Cart3 = ShoppingCartItem.create!(user_id: User2, item_id: 3 )
Shopping_Cart4 = ShoppingCartItem.create!(user_id: User2, item_id: 1 )
Shopping_Cart5 = ShoppingCartItem.create!(user_id: User3, item_id: 3 )
Shopping_Cart6 = ShoppingCartItem.create!(user_id: User3, item_id: 4 )
